        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = ArithParser.MulDivContext(self, ArithParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        self.state = 32
                        _la = self._input.LA(1)
                        if not(_la==ArithParser.MUL or _la==ArithParser.DIV):
                        ...
                        localctx = ArithParser.AddSubContext(self, ArithParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 34
                        ...
                        self.state = 35
                        _la = self._input.LA(1)
                        if not(_la==ArithParser.ADD or _la==ArithParser.SUB):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
